			...
			__all__: {
				...
				__init__: function (__all__) {
					...
					var run = function (autoTester) {
						...
						__call__ (autoTester.check, autoTester, 'r / r', __call__ (__call__ (num.round, num, __add__ (__div__ (r, r), delta), 3).tolist, __call__ (num.round, num, __add__ (__div__ (r, r), delta), 3)), '<br>');
						...
						__call__ (autoTester.check, autoTester, 'c / c', __call__ (__call__ (num.round, num, __add__ (__div__ (c, c), delta), 3).tolist, __call__ (num.round, num, __add__ (__div__ (c, c), delta), 3)), '<br>');
